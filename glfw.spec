...
%prep
%setup -q -n glfw-3.3.2
cd %{_builddir}/glfw-3.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605557005
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/glfw-3.3.2/LICENSE.md %{buildroot}/usr/share/package-licenses/glfw/55822a091dca212023dfde6e6fb53df49288dbd8
pushd clr-build
%make_install
popd
